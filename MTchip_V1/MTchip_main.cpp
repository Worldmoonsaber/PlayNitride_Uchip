...
int main()
{
	...
	float outputLEDY[500];
		...
		//thresParm = { 4,{200,107,107},{99999,99999,99999} ,{1,9,9}, {99999,99999,99999} }; //MTchip-G、B[0]
		...
		//thresParm = { 0,{99999,99999,99999},{99999,99999,99999} ,{threslist[0],threslist[0],threslist[0]}, {0,0,0} };//Uchip: B，G，R
		...
		if (boolflag == 0)
		{
			...
			//if (chipsetting.carx==0 && chipsetting.cary == 0) //防呆 以防萬一
			//{
